...
const { name:n, price, instructor, duration } = course; // Destructuring the object 
// name:n is an example of renaming the variable during destructuring
console.log(n); // "JavaScript Basics"
console.log(price); // 199
console.log(instructor); // "John Doe"
console.log(duration); // "4 weeks"

// When api call through json what happens
// {
//     "name": "JavaScript Basics",
//     "price": 199,   
//     "instructor": "John Doe",
